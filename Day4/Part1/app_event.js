...
recipes.forEach(({ name, rating, cuisine, image, servings }) => {
    const newdiv = document.createElement("div");
    const popupview = document.createElement("div");
    popupview.className = "popupview";
    newdiv.className = "card";
    newdiv.innerHTML = `
        <p style="font-weight: bold; font-size: 15px;">${name}</p>
        // <img src="${image}" style="width: 100%; height: auto; border-radius: 5px; margin: 10px 0;">
        <p style="color: #333;">Cuisine: ${cuisine}</p>
        <p style="color: #333;">Rating: ${rating}</p>
        <p style="color: #333;">Servings: ${servings}</p>
        <button class="alertbtn">click me</button>
    `;
...
const buttons = document.getElementsByClassName("alertbtn");
