...
// //take the dummy data and use it to display the name and the cuisine from it using 
// // i) for loop ii) foreach iii) map

const {recipes} = data;

// //METHOD 1:
// for (const {name,cuisine} of recipes){
//     console.log("Name: "+ name + " , " +"Cuisine: "+ cuisine)
// }
...
//     newarr.push({name,cuisine})
// }
// console.log(newarr);

// //METHOD 3:
// recipes.forEach(({name,cuisine})=>{
//     console.log("Name: "+ name + " , " +"cuisine: "+ cuisine)
// })

// //METHOD 4:
// const newarr2 = recipes.map(({name,cuisine})=>({name,cuisine}));
// console.log(newarr2);

// const newarr5 = recipes.map((ele)=>{
//     const {name,cuisine} = ele;
//     return {name,cuisine}
// });
// console.log(newarr5);

// // Write code to display but display only name and age
// const arr3 = [
//     {name: "sam",
//     age: 20,
//     password: "sam123"},
...
//till here it will filter the data and return the new array but will display the whole object
//so we need to display only the name and rating thats why we are using map to further shorten and just display the neccessary data
const finalarr6 = arr6.map((ele)=>{
    const {name,rating} = ele;
    return {name,rating}
})
