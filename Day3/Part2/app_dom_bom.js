...
// title.innerHTML= "hello from title";
// const parent = document.getElementById("root")
// parent.append(title)
// const title1 = document.createElement("h1")
// title1.innerHTML= "hello from title 1";
// parent.append(title1)
// // Apply styles
// title.style.color = "orange";
// title.style.font = "bold 50px 'Bradley Hand', cursive";
// title1.style.color = "black";
// title1.style.font = "bold 50px 'Bradley Hand', cursive";
...
//         //Method 3:
//         const newdeading = document.createElement("h2");
//         newdiv.className="card"
//         newdiv.innerHTML = item.title;
//         newdiv.append(newdeading);
...
const createui = ()=>{
    recipes.forEach((item)=>{
        ...
        const newmealtype = document.createElement("p");

        newdiv.className="card";
        newheading.className="heading";
        newimage.className="image";
        newrating.className="rating";
        newmealtype.className="mealtype";

        newheading.innerText = item.name;
        newimage.src = item.image;
        newrating.innerText = "Rating: "+ item.rating;
        newmealtype.innerText = item.mealType
        
        newdiv.append(newheading);
        newdiv.append(newimage);
        newdiv.append(newrating);
        newdiv.append(newmealtype);
        parent.append(newdiv);
    })
}
